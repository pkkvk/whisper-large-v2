...
def inference(model_inputs:dict) -> dict:
    ...
    result = model.transcribe("input.mp3",
                             ...
                             logprob_threshold= model_inputs.get('compression_ratio_threshold',-1.0),
                             no_speech_threshold= model_inputs.get('compression_ratio_threshold',0.6),
                             condition_on_previous_text.get('condition_on_previous_text',True), 
                             ...
                             prompt= model_inputs.get('best_of',None))
